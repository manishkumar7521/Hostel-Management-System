...
public class EmployeePayment extends javax.swing.JFrame {
    ...
    /**
     * Creates new form EmpolyeePayment
     */
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try{
            Connection con = ConnectionProvider.getCon();
            Statement st = con.createStatement();
            ResultSet rs = st.executeQuery("select * from employees where mobileNo = '"+mobileNo+"' and status ='Working'");
            if(rs.next()){
            ...
            ResultSet rs1 = st.executeQuery("select * from payment inner join employees where employees.status='Working' and payment.month='"+month+"' and payment.mobileNo='"+mobileNo+"' and employees.mobileNo='"+mobileNo+"'");
            if(rs1.next()){
